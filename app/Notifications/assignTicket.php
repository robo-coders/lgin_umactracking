...
class assignTicket extends Notification implements shouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->line("Your request# ".$this->ticket->request_id." has been assigned to a Technician ".$this->ticket->technician->name)
                    ->action('Labor Tracker', url('/'))
                    ->line('Thank you for createing a request!');
    }
/**
    ...
    {
        return [
            "data" => "Your request# ".$this->ticket->request_id." has been assigned to a Technician ".$this->ticket->technician->name,
